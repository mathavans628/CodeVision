...
public class GenerateCodeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] arr= new String[] {" java"," java "," js"," js "," javascript"," javascript "," python"," python "," cpp"," cpp "," c++"," c++ "," ruby"," ruby "," go"," golang "," go "," golang"," rlang"," rlang "," r "," php"," php "," c "," c "};
...
//		WebElement waiting = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"uiOutputHtml\"]/h2")));
        ...
        if(lang.equals(" js") || lang.equals(" js ") || lang.equals(" javascript ") || lang.equals(" javascript"))
		{
			lang = "javascript";
		}
		...
		else if(lang.equals(" go") || lang.equals(" go ") || lang.equals(" golang ") || lang.equals(" golang"))
		{
			lang = "golang";
		}
		else if(lang.equals(" r") || lang.equals(" r ") || lang.equals(" rlang ") || lang.equals(" rlang"))
		{
			lang = "rlang";
		}
		...
		else if(lang.equals(" php ") || lang.equals(" php"))
		{
			lang = "php";
		}
		else if(lang.equals(" ruby ") || lang.equals(" ruby"))
		{
			lang = "ruby";
		}
